...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/mayousheng/project/git/vue-file-upload/demo/app.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vueFileUpload = __webpack_require__(7);
	
	var _vueFileUpload2 = _interopRequireDefault(_vueFileUpload);
	
	var _msg = __webpack_require__(40);
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    uploadItem: function uploadItem(file) {
	      file.upload();
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/mayousheng/project/git/vue-file-upload/src/vue-file-upload.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-9261aca0&file=vue-file-upload.vue&scoped=true!./../node_modules/stylus-loader/index.js!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./vue-file-upload.vue", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-9261aca0&file=vue-file-upload.vue&scoped=true!./../node_modules/stylus-loader/index.js!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./vue-file-upload.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".fileupload-button[_v-9261aca0] {\n  position: relative;\n  overflow: hidden;\n  display: inline-block;\n  color: #fff;\n  padding: 6px 12px;\n  background-color: #5cb85c;\n  border-color: #4cae4c;\n  margin: 0;\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 1.42857143;\n  text-align: center;\n  white-space: nowrap;\n  vertical-align: middle;\n  cursor: pointer;\n}\n.fileupload-button input[type=file][_v-9261aca0] {\n  position: absolute;\n  top: 0;\n  right: 0;\n  margin: 0;\n  opacity: 0;\n  -ms-filter: 'alpha(opacity=0)';\n  font-size: 200px;\n  direction: ltr;\n  cursor: pointer;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _public = __webpack_require__(29);
	...
	var _fileUploader = __webpack_require__(41);
	...
	exports.default = {
	  ...
	  created: function created() {
	    ...
	    this.fileUploader = new _fileUploader2.default((0, _extends3.default)({
	      vm: this,
	      url: this.url,
	      name: this.name,
	      maxItems: this.max,
	    ...
	    }, this.requestOptions, this.events));
	
	    this.$on(_msg2.default.DOPOST, this._uploadAll);
	    this.$on(_msg2.default.DOABORT, this._abortUpload);
	  },
	  ready: function ready() {
	    if (this.$els.fileInput && this.multiple) {
	      this.$els.fileInput.setAttribute('multiple', this.multiple);
	    }
	    _public2.default.on(this.$els.fileInput, "change", this._onChange);
	  },
	  beforeDestroy: function beforeDestroy() {
	    _public2.default.off(this.$els.fileInput, "change");
	  ...
	  methods: {
	    ...
	    _uploadAll: function _uploadAll() {
	      this.fileUploader.uploadAll();
	    },
	    _abortUpload: function _abortUpload(file) {
	      this.fileUploader.abortItem(file);
	    },
	    _onChange: function _onChange() {
	      //文件已数组为单位，因为可能存在mutiple；如果是单个文件fileuploader会自动转换为数组类型！
	      var elTargetFiles = _public2.default.isHTML5() ? this.$els.fileInput.files : this.$els.fileInput;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getOwnPropertyDescriptor = __webpack_require__(30);
	...
	var pub = {};
	_vue2.default.util.extend(pub, _vue2.default.util);
	...
	pub.extend(pub, {
	  ...
	  extend: function extend(target) {
	    ...
	    sources.forEach(function (source) {
	      (0, _defineProperties2.default)(target, (0, _keys2.default)(source).reduce(function (descriptors, key) {
	        descriptors[key] = (0, _getOwnPropertyDescriptor2.default)(source, key);
	        return descriptors;
	      }, {}));
	    });
	    return target;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fileUploaderOptions = __webpack_require__(46);
	
	var _fileUploaderOptions2 = _interopRequireDefault(_fileUploaderOptions);
	
	var _fileItem = __webpack_require__(47);
	
	var _fileItem2 = _interopRequireDefault(_fileItem);
	
	var _fileAlias = __webpack_require__(48);
	
	var _fileAlias2 = _interopRequireDefault(_fileAlias);
	...
	var FileUploader = (function () {
	  function FileUploader(options) {
	    ...
	    _public2.default.extend(this, _fileUploaderOptions2.default, options, {
	      fileindex: 0,
	      isUploading: false,
	      failFilterIndex: -1
	    });
	  ...
	  (0, _createClass3.default)(FileUploader, [{
	    ...
	    value: function addToQueue(files) {
	      ...
	      var uploader = this;
	      var files = uploader._isFileList(files) ? _public2.default.toArray(files) : [files];
	
	      //file可能是File,htmlInputElement,Object
	      files.forEach(function (file) {
	        var fileAlias = new _fileAlias2.default(file);
	        if (uploader._isValidFile(fileAlias, uploader.filters)) {
	          var fileItem = new _fileItem2.default(_this, file, fileAlias);
	    ...
	    value: function uploadItem(fileItem) {
	      ...
	      var postMethod = _public2.default.isHTML5() ? "_xhrPost" : "_iframePost";
	    ...
	    key: 'abortItem',
	    value: function abortItem(item) {
	      var prop = _public2.default.isHTML5() ? '_xhr' : '_form';
	    ...
	    key: 'removeFromQueue',
	    value: function removeFromQueue(fileItem) {
	    ...
	    key: 'getNextReadyItems',
	    value: function getNextReadyItems() {
	      return this.queue.filter(function (item) {
	    ...
	    key: '_onProgressUpload',
	    value: function _onProgressUpload(fileItem, progress) {
	    ...
	    value: function onProgressUpload(fileItem, progress) {}
	    ...
	    key: '_onSuccessUpload',
	    value: function _onSuccessUpload(fileItem, response, status, headers) {
	      fileItem.onSuccess();
	    ...
	    key: 'onSuccessUpload',
	    value: function onSuccessUpload(fileItem, response, status, headers) {}
	    ...
	    key: '_onCompleteUpload',
	    value: function _onCompleteUpload(fileItem, response, status, headers) {
	      this.onCompleteUpload(fileItem, response, status, headers);
	      var nextItem = this.getNextReadyItems()[0];
	      this.isUploading = false;
	
	      if (_public2.default.isObject(nextItem)) {
	        nextItem.upload();
	      }
	    }
	    /**
	    ...
	    key: 'onCompleteUpload',
	    value: function onCompleteUpload(fileItem, response, status, headers) {}
	    ...
	    key: '_onErrorUpload',
	    value: function _onErrorUpload(fileItem, response, status, headers) {
	      fileItem.onError();
	    ...
	    key: 'onErrorUpload',
	    value: function onErrorUpload(fileItem, response, status, headers) {}
	    /**
	    ...
	    key: '_onAbortUpload',
	    value: function _onAbortUpload(fileItem, response, status, headers) {
	      fileItem.onAbort();
	    ...
	    key: 'onAbortUpload',
	    value: function onAbortUpload(fileItem, response, status, headers) {}
	    ...
	    key: '_onBeforeUpload',
	    value: function _onBeforeUpload(fileItem) {
	      fileItem.onBeforeUpload();
	      this.onBeforeUpload(fileItem);
	    }
	  }, {
	    key: 'onBeforeUpload',
	    value: function onBeforeUpload(fileItem) {}
	    /**
	    ...
	    key: '_isFileList',
	    value: function _isFileList(fileList) {
	    ...
	    key: '_isValidFile',
	    value: function _isValidFile(file, filters) {
	      var _this2 = this;
	
	      this.failFilterIndex = -1;
	      return !filters.length ? true : filters.every(function (filter) {
	        _this2.failFilterIndex++;
	        return filter.fn.call(_this2, file);
	      });
	    }
	    /**
	    ...
	    value: function _parseHeaders(headers) {
	      var json = {};
	      if (_public2.default.isObject(headers)) return;
	      headers.split("\n").forEach(function (header) {
	        var index = header.indexOf(":");
	        if (index > -1) {
	          var key = header.slice(0, index).trim();
	          var val = header.slice(index + 1).trim();
	    ...
	    key: '_xhrPost',
	    value: function _xhrPost(fileItem) {
	      var uploader = this;
	      //保留xhr对象，防止abort可以执行
	      ...
	      //追加formdata
	      if (!_public2.default.isEmptyObject(uploader.formData)) {
	        for (var key in uploader.formData) {
	      ...
	      //添加header信息
	      if (!_public2.default.isEmptyObject(uploader.headers)) {
	        for (var key in uploader.headers) {
	    ...
	    key: '_iframePost',
	    value: function _iframePost(filecontrol) {
	      var uploader = this;
	      ...
	      _public2.default.on(iframe, "load", function () {
	        var response = '';
	        var status = 200;
	        var headers = {};
	        try {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FileItem = (function () {
	  function FileItem(uploader, fileObject, fileAlias) {
	    (0, _classCallCheck3.default)(this, FileItem);
	
	    var file = _public2.default.isFile(fileObject) ? fileObject : null;
	    var input = file ? null : fileObject;
	    _public2.default.extend(this, {
	      uploader: uploader,
	      file: file,
	      input: input,
	      index: null,
	  ...
	  (0, _createClass3.default)(FileItem, [{
	    key: 'upload',
	    ...
	    key: 'onPrepareUpload',
	    value: function onPrepareUpload() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FileAlias = (function () {
	  function FileAlias(fileObject) {
	    (0, _classCallCheck3.default)(this, FileAlias);
	
	    if (_public2.default.isFile(fileObject)) {
	  ...
	  (0, _createClass3.default)(FileAlias, [{
	    key: 'createFileFromInput',
	    value: function createFileFromInput(path) {
	    ...
	    key: 'createFile',
	    value: function createFile(object) {
	...
	exports.default = FileAlias;

/***/ },
/* 49 */
/***/ function(module, exports) {

	module.exports = "<span class=\"fileupload-button\" _v-9261aca0=\"\">\n  <i v-if=\"icon != null\" v-bind:class=\"rendIcon\" _v-9261aca0=\"\"></i>\n  {{label}}\n  <input v-el:file-input=\"\" type=\"file\" name=\"file\" _v-9261aca0=\"\">\n</span>";
